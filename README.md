...
* experimenting with [cursed Gradle megaprojects](https://github.com/quat1024/mods) to ease the updating and backporting workload
...
More articles on [my blog](https://highlysuspect.agency/) and some unsorted things in [my Voldeloom fork](https://github.com/CrackedPolishedBlackstoneBricksMC/voldeloom/tree/disaster-time/quat_notes).

## Let's talk?

📨 [quat@highlysuspect.agency](mailto:quat@highlysuspect.agency)

To ask a question about my Minecraft mods, please file an issue or join my [public Discord](https://highlysuspect.agency/discord).
